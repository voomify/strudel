...
begin
  ...
  puts "chef has been installed for you, please rerun 'rake strudel:install'"
  puts "If you keep getting this message, you should manually install the chef gem before running 'rake strudel:install'"
end
